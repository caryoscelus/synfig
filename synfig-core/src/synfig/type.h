...
#define SYNFIG_IMPLEMENT_TYPE_ALIAS(T, Class) \
	...
	SYNFIG_DECLARE_TYPE_ALIAS(etl::handle<ValueNode_Patch>)
	SYNFIG_DECLARE_TYPE_ALIAS(etl::loose_handle<ValueNode_Patch>)
	SYNFIG_DECLARE_TYPE_ALIAS(ValueNode_Patch*)
